...
def _parse_nastran_version_8(data: bytes, version: bytes, encoding: str, log) -> str:
    ...
    if version.startswith(b'NX'):
        ...
        mode = 'msc'
                     ...
                     b'OS2019', b'OS2019.1', b'OS2019.2',
                     b'OS2019.3', b'OS2019.4', b'OS2020',
                     b'OS2020.1', b'OS2020.2', b'OS2020.3',
                     b'OS2020.4', b'OS2021', b'OS2021.2',
                     b'OS2021.3', b'OS2021.4', b'OS2022',
                     b'OS2020.1', b'OS2020.2', b'OS2022.3']:
